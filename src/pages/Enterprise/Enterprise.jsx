...
export default function Enterprise() {
  ...
  return (
    <div className="enterprise-page">
      ...
      {/* ── Testimonial ── */}
      <section className="ep-testimonial">
        <div className="ep-container">
          <div className="ep-testimonial__card">
            <svg className="ep-quote-icon" viewBox="0 0 24 24" fill="currentColor"><path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z"/></svg>
            <blockquote>
              "Implementing WorkKudo at the enterprise level completely transformed our cross-functional appreciation. We saw a 40% increase in employee retention metrics within the first year. The SSO and automated HRIS sync made rollout to our 12,000 employees completely frictionless."
            </blockquote>
            <div className="ep-testimonial__author">
              <img src="https://images.unsplash.com/photo-1560250097-0b93528c311a?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80" alt="VP of HR" />
              <div>
                <strong>Marcus Chen</strong>
                <span>VP of Global People Ops, TechCorp</span>
              </div>
            </div>
          </div>
        </div>
